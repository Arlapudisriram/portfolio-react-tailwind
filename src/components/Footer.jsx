...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/httsriram-arlapudi-29560a230/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://www.instagram.com/sriram_varma853/", label: "Instagram" },
    { icon: <Github size={18} />, href: "https://github.com/Arlapudisriram", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "sriramvarma853@gmail.com", href: "mailto:sriramvarma853@gmail.com.com" },
    { icon: <Phone size={16} />, text: "+91 9666345431", href: "tel:+919666345431" },
  ];
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">SRIRAM</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
               Frontend Developer building fast, responsive, and modern web experiences.
              </p>
          ...
          >
            <div>
              <p>© {currentYear} Sriram. All rights reserved.</p>
            </div>
