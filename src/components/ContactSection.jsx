...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try again or email me directly at sriramvarma853@gmail.com",
        variant: "destructive"
      });
    } finally {
  ...
  return (
    ...
    whileInView="visible"
    viewport={{  once: true }}
    id="contact" className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 relative bg-background">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12">
          {/* Contact Information */}
          <div className="space-y-6 sm:space-y-8 p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-gradient-to-br from-secondary/20 to-background border border-gray-300">
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/httsriram-arlapudi-29560a230/",
                  },
                  {
                    icon: Twitter,
                    label: "Twitter",
                  ...
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/Arlapudisriram",
                  },
                  {
                    icon: Instagram,
                    label: "Instagram",
                    url: "https://www.instagram.com/sriram_varma853/",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
          ...
          {/* Contact Form */}
          <div className="p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-card border border-gray-300 shadow-sm">
            <h3 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 flex items-center gap-2">
              <span className="w-3 sm:w-4 h-3 sm:h-4 rounded-full bg-primary"></span>
              Send Me a Message
            </h3>
