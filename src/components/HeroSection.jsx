...
export const HeroSection = () => {
  ...
  const codeSnippets = [
    "import { FrontendDeveloper } from 'sriram.dev';",
    "",
    "const developer = new FrontendDeveloper({",
    "  name: 'Sriram',",
    "  stack: ['React', 'JavaScript,   'TailwindCSS', 'Next.js','TypeScript'],",
    "  focus: 'Crafting clean, responsive, and interactive user interfaces'",
    "  status: 'Open to Frontend and React opportunities',",
    "});",
    "",
    "developer.buildProjects",
        "//  Featured: 'Responsive UIs','Portfolio Websites', 'Web Applications';",
    "developer.showcaseSkills();",
    "console.log('🚀 Turning ideas into responsive, user-focused web experiences.');",
  ];
...
useEffect(()=>{
  ...
  const handleViewResume = () => {
    ...
    window.open('/FrontendDeveloper_Sriram_Resume.pdf', '_blank', 'noopener,noreferrer');
  };


  return (
    
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-white dark:bg-[#0a0a0a] " ref={ref}>
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <motion.div className="absolute top-20 left-10 w-72 h-72 rounded-full bg-gradient-to-r from-primary/10 to-purple-600/10 blur-[100px] dark:from-primary/5 dark:to-purple-600/5 " animate={{ x: [0, 30, 0], y: [0, -30, 0], scale: [1, 1.1, 1] }} transition={{ duration: 15, repeat: Infinity }} />
        <motion.div className="absolute bottom-20 right-10 w-72 h-72 rounded-full bg-gradient-to-r from-cyan-400/10 to-emerald-500/10 blur-[100px]  dark:from-cyan-400/5 dark:to-emerald-500/5 " animate={{ x: [0, -40, 0], y: [0, 40, 0], scale: [1, 1.2, 1] }} transition={{ duration: 20, repeat: Infinity, delay: 2 }} />
      </div>
      ...
      <div className="container max-w-7xl  mx-auto w-full mt-16 sm:mt-0">
        <motion.div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-20" initial="hidden" animate={isInView ? "visible" : "hidden"} variants={{ hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.25, delayChildren: 0.5 } } }}>
          ...
          <div className="flex-1 text-center  min-h-screen lg:text-left max-w-2xl mx-auto lg:mx-0">
            <motion.div className="inline-flex items-center gap-2 px-4 py-2 rounded-full  bg-primary/10 border border-primary/20 text-primary text-sm font-medium mb-8 backdrop-blur-sm" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              <Briefcase className="h-4 w-4 " /> Open to Frontend / React Developer Oppurtunities
            </motion.div>
            ...
            <motion.h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              ...
              <motion.span className="block mt-4 bg-gradient-to-r from-primary via-purple-600 to-pink-600 bg-clip-text text-transparent" animate={{ backgroundPosition: ['0%', '100%', '0%'] }} transition={{ duration: 8, repeat: Infinity }} style={{ backgroundSize: '200% 100%' }}>
                Frontend Developer
              </motion.span>
            </motion.h1>

            <motion.p className="text-lg sm:text-xl text-foreground mt-12 leading-relaxed max-w-2xl" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              Crafting  <span className="text-primary font-semibold">high-quality web experiences with React ,Tailwind , TypeScript and Next.js .</span> I create projects ranging from SaaS applications and AI tools to media platforms and productivity apps.
            </motion.p>

            

            <motion.div className="flex flex-col sm:flex-row gap-4 mt-12 justify-center lg:justify-start" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              <motion.a href="/Projects" className="group relative overflow-hidden px-8 py-4 rounded-xl font-semibold bg-gradient-to-r from-blue-400 to-violet-400 text-primary-foreground shadow-lg hover:shadow-xl text-sm flex items-center justify-center gap-3" whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.95 }}>
              ...
              <motion.button 
                ...
                className="group relative overflow-hidden px-6 py-4 rounded-xl font-semibold border border-gray-300 text-foreground hover:border-primary/30 transition-all duration-300 bg-background/60 backdrop-blur-sm text-sm flex items-center justify-center gap-2" 
            ...
            <motion.div className="mt-6 text-center lg:text-left" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
              <div className="text-sm mt-8  text-foreground">
                🚀 <span className="text-primary font-semibold">Available Immediately</span> for Frontend and React roles
              </div>
            </motion.div>
          </div>
...
{/* -------------------------Code snippet---------------- */}
          ...
          <motion.div className="flex-1 flex justify-center min-h-screen mt-10  lg:justify-end w-full" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
            <div className="relative w-full  max-w-lg">
              <motion.div className="bg-background/90 border-0 dark:border dark:border-white/10 rounded-2xl p-8 backdrop-blur-sm shadow-2xl w-full group hover:shadow-3xl transition-all duration-500" whileHover={{ y: -4 }} transition={{ type: "spring", stiffness: 400, damping: 25 }}>
                ...
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex-1 text-center">
                    <div className="text-sm font-mono font-semibold text-muted-foreground dark:text-muted-foreground/80">portfolio.js</div>
                  </div>
                        ...
                        <div 
                          ...
                          className={`
                            ...
                            ${line.includes("import") ? "text-purple-400 font-semibold" : 
                              ...
                              line.includes("React") || line.includes("Next.js") || line.includes("TypeScript") ? "text-cyan-400 dark:text-cyan-500" :
                              line.includes("developer.showcaseSkills") ||  line.includes("developer.buildProjects")  ? "text-yellow-400 font-semibold" :
                              line.includes("//") ? "text-foreground italic" :
                ...
                <motion.div className="absolute -top-3 -left-3 bg-background/90 backdrop-blur-sm px-4 py-2 rounded-xl border-0 shadow-lg flex items-center gap-2" initial={{ scale: 0, rotate: -180 }} animate={{ scale: 1, rotate: 0 }} transition={{ delay: 1.5, type: "spring" }}>
                  <Award className="h-4 w-4 text-amber-500" />
                  <span className="text-sm font-semibold text-foreground">Solutions</span>
                </motion.div>
                
                <motion.div className="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-background/90 backdrop-blur-sm px-4 py-2 rounded-xl border shadow-lg text-center" initial={{ scale: 0, y: 20 }} animate={{ scale: 1, y: 0 }} transition={{ delay: 2, type: "spring" }}>
...
//     "// Featured: SaaS, Enterprise Tool, Media , Utility , Productivity",
//     "",
//     "developer.connect();",
...
//             <motion.div className="inline-flex mt-5 items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium mb-8 backdrop-blur-sm" variants={{ hidden: { y: 30, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.8 } } }}>
//               <Briefcase className="h-4 w-4 " /> Open to Frontend/React Opportunities
//             </motion.div>
