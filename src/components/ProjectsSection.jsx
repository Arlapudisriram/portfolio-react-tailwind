...
const projects = [
  {
    id: 8,
    title: "Weight loss SaaS",
    category: "AI SaaS ",
    description: "AI-powered weight loss web app built with React, Vite, Tailwind, Clerk, and Google Gemini API.",
    image: "/Weightloss.png",
    tags: ["React" , "Vite" , "Tailwind CSS" , "Clerk AUTH" , "Google Gemini API","Firebase"],
    demoUrl: "https://weight-loss-saas.vercel.app/",
    githubUrl: "https://github.com/Arlapudisriram/weight-loss-saas",
    featured: true,
    accentColor: "from-emerald-500 to-teal-600",
    status: "Live",
    highlights: [ "Personalized Meal Plans",
  "AI Fitness & Nutrition Guidance",
  "Progress Tracking Dashboard",
  "Weight & Calorie Analytics",
  ...
  },
  {
    ...
    title: "Interview GPT",
    category: "EdTech",
    description: "AI-powered interview preparation assistant that helps users practice questions, improve answers, and boost confidence.",
    image: "/GPT.png",
    tags: ["Google Gemini API", "Google Gemini API", "Vite", "React", "Tailwind"],
    demoUrl: "https://gemini-interview-tool.vercel.app/",
    githubUrl: "https://github.com/Arlapudisriram/gemini-interview-tool",
    featured: true,
    accentColor: "from-emerald-500 to-teal-600",
    status: "Live",
    highlights: ["AI-Powered Interview Coaching","Custom Interview Scenarios","Performance Insights & Analytics"]
  },
  {
    id: 1,
    title: "Netflix Clone",
    category: "Media & Entertainment",
    description: "Netflix-style streaming platform with React, Tailwind, Vite, and TMDB integration.",
    image: "/Netflix.png",
    tags: ["TMDB API", "Vite", "Tailwind CSS", "Javascript","React "],
    demoUrl: "https://netflix-clone-application-orpin.vercel.app/",
    githubUrl: "https://github.com/Arlapudisriram/Netflix-clone-application",
    featured: true,
    accentColor: "from-purple-500 to-indigo-600",
    status: "Live",
    highlights: ["Movie & TV Show Browsing", "Search & Filtering", "Watchlist / Favorites"]
  },
...
const categoryColors = {
  "AI SaaS": "from-emerald-500/20 to-teal-600/20 text-emerald-600 border-emerald-500/30",
  "EdTech": "from-purple-500/20 to-indigo-600/20 text-purple-600 border-purple-500/30",
  "Media & Entertainment": "from-blue-500/20 to-cyan-600/20 text-blue-600 border-blue-500/30",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
          <AnimatePresence mode="wait">
            {displayedProjects.map((project, index) => (
              ...
              >
                <div className="relative bg-background border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-500 h-full flex flex-col">
